SelCyl_Type	Int
SelCyl_Toleranse	Real
SelCyl_MaxPos	Real
SelCyl_MinPos	Real
 variables are added in DB_manual but they should be implamented 
...
1. Pul tutucu piston istenilen konuma kadar açılacak, operatör pul takip çift buton start verecek
2. Karşı punta açılacak 
3. Taret home da ise taret kilit pistonu açık olacak ve takım değişecek. Takım değiştirme bitince kapanacak 
4. Arka dayama pistonu istenilen yere kadar açılacak
5. Pul tutucu piston kapanacak
6. Sıvama başlayacak 
7. Sıvama bittikten sonra karşı punta kapanacak, aynı zamanda pul tutucu piston istenilen konuma tekrar geri gelecek
8. Bitmiş parça alınacak
9. Yeni pul takılıp çift buton start verilecek
10. 2 numaradan tekrar devam
