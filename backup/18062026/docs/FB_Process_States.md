...
**Last updated:** 2026-06-16 — STOPPING now returns X and Z to zero simultaneously (MC_MoveAbsolute, parallel); bResetRecipe added to STATE_STOPPED and STATE_MANUAL Cmd_Start handlers to prevent false "recipe complete" on re-start after stop/error
