...
| `DB_Cylinder1` | `FB_CylinderControl` | `"DB_Cylinder1"(...)` |
| `DB_Sen_Cyl1_Setpt` | `FB_DigitalSensor` | `"DB_Sen_Cyl1_Setpt"(RawInput:=...)` |
| `DB_Sen_Cyl1_Ret` | `FB_DigitalSensor` | `"DB_Sen_Cyl1_Ret"(RawInput:=...)` |
| `DB_LinearRuler1` | `FB_AnalogSensor` | `"DB_LinearRuler1"(AI_Raw:=...)` |
