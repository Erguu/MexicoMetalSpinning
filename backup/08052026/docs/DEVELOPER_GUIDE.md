...
-------------------------
- Version_Recipe/01_DataTypes.scl  — common UDTs and types
- Version_Recipe/02_DataBlocks.scl — DB definitions (DB_HMI, DB_MachineConfig, DB_ToolConfig, DB_RecipeProgramX)
- Version_Recipe/04_ToolChanger.scl — FB_ToolChanger (rotates turret / moves to tool-change pos)
- Version_Recipe/05_RecipeHandler.scl — FB_RecipeHandler (main recipe executor)
- Version_Recipe/06_MainProcess.scl — FB_Process (supervisory state machine, Apply mapping)
- Version_Recipe/DB_RecipeProgram1.scl — example parsed recipe (Lines[] array)
...
```284:317:c:\Users\PC\Documents\Automation\Cursor\MexicoMetalSpinning\Version_Recipe\05_RecipeHandler.scl
// Check command type
