...
| **Recipe Selector** | `DB_HMI.ProductSelect` | Int | **1-50** | Which recipe to use. 1-5 until 2026-08-04, 1-10 until 2026-08-10, now **1-50**. Clamped in FB_Process; the clamp is generated by `tools/gen_recipe_slots.py`. **HMI input range must be widened to 50** |
